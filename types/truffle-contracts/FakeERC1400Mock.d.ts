...
export interface FakeERC1400MockContract
  extends Truffle.Contract<FakeERC1400MockInstance> {
  "new"(
    name: string,
    symbol: string,
  ...
  ): Promise<FakeERC1400MockInstance>;
}
...
export interface FakeERC1400MockInstance extends Truffle.ContractInstance {
  addMinter: {
