...
export interface IERC1400Contract extends Truffle.Contract<IERC1400Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IERC1400Instance>;
}
...
export interface IERC1400Instance extends Truffle.ContractInstance {
  /**
