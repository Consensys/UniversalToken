...
export interface ERC1400HoldableCertificateTokenContract
  extends Truffle.Contract<ERC1400HoldableCertificateTokenInstance> {
  "new"(
    name: string,
    symbol: string,
  ...
  ): Promise<ERC1400HoldableCertificateTokenInstance>;
}
...
export interface ERC1400HoldableCertificateTokenInstance
