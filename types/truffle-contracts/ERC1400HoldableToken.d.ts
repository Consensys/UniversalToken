...
export interface ERC1400HoldableTokenContract
  extends Truffle.Contract<ERC1400HoldableTokenInstance> {
  "new"(
    name: string,
    symbol: string,
  ...
  ): Promise<ERC1400HoldableTokenInstance>;
}
...
export interface ERC1400HoldableTokenInstance extends Truffle.ContractInstance {
  addMinter: {
