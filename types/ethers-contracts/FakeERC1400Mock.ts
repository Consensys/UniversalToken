...
export interface FakeERC1400MockInterface extends utils.Interface {
  functions: {
...
export interface FakeERC1400Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FakeERC1400MockInterface;
