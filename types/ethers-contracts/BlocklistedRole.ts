...
export interface BlocklistedRoleInterface extends utils.Interface {
  functions: {
...
export interface BlocklistedRole extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BlocklistedRoleInterface;
