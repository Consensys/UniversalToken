...
/**
 * @title ERC1400HoldableCertificateTokenMock
 * @dev Holdable ERC1400 with certificate controller logic
 */
contract ERC1400HoldableCertificateTokenMock is ERC1400HoldableToken, CertificateControllerMock {

  /**
   * @dev Initialize ERC1400 + setup the token extension + initialize certificate controller.
