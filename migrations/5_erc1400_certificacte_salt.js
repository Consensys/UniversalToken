const ERC1400CertificateSalt = artifacts.require('./ERC1400CertificateSalt.sol');
...
module.exports = async function (deployer, network, accounts) {
  await deployer.deploy(ERC1400CertificateSalt, 'ERC1400CertificateSalt', 'DAU', 1, [controller], CERTIFICATE_SIGNER, true, partitions);
  console.log('\n   > ERC1400CertificateSalt token deployment: Success -->', ERC1400CertificateSalt.address);
};
